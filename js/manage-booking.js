...
function renderMbLoginScreen() {
  return `
    <div class="bw-sheet-header" style="padding:0 0 16px;border:none;">
      <span class="bw-screen-title">Manage Your Booking</span>
    </div>
    <p style="font-size:13px;color:#5c7a80;padding:0 var(--bw-pad) 16px;margin:0;">Enter the email and mobile number you used when booking to verify it's you.</p>
