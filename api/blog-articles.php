 ...
 * https://drpujaprasad.in/api/blog-articles.php (and, via .htaccess rewrite,
 * https://drpujaprasad.in/api/blog/articles) works, WITHOUT the real backend
 ...
 */
require dirname($_SERVER['DOCUMENT_ROOT']) . '/backend/api/blog-articles.php';
